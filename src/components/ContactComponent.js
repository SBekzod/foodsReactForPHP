...
function RenderComments({ ele }) {
    return (
        <div key={ele.comment_id}>
            <h4 className="colortext"><span className="fa fa-commenting-o"></span> Author: {ele.author}</h4>
            <h5><i>"{ele.commenting}"</i></h5>
            <h6> user rating: {ele.rating}</h6>
        </div>
    );
}
...
class Contact extends Component {
    ...
    handleSubmit(values) {
        this.props.addNewComment({ author: values.firstname, rating: values.rating, commenting: values.comment });
    }
        ...
        return (
            <div className="container">
                ...
                {!this.props.auth.isAuthenticated ?
                    <div className="row">
                        <div className="col-12 offset-4"><h4 className="colortexttwo">Login to Comment about us</h4></div>
                    </div>
                    :
